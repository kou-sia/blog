...
※大前提  
わざわざ時間をかけて面接を受けていただいているので基本的には採用したいと思って面接しています。  
...
そこでわかった事を整理します。  
面接をする上でのポイントは面接を受ける側から見ても有用なものだと思いますので、  
面接官をしない方にも読んでもらいたいです。　　
...
あくまでも面接官と応募者は対等な存在であり、ご縁があり入社された場合には同じチームで働く可能性を想定していますので、面接官の誤りは指摘して欲しいという意図があります。  
...
下に書いたようなことがわかっていれば、問題なく一緒にやっていけるだろうと判断します。  
（もちろんカルチャーマッチなども重要ですが、あくまでもそれは以下を満たしてから判断します。）
...
(というのもこれは日本特有なのかは分かりませんが、多重下請け構造の元でエンジニアをされている方が応募されてくる場合など、過去の成果が細分化された作業に終始しており、説明を聞いても応募者本人の能力に対する判断材料として全く当てにならない場合が多々あります。しかし、これは日本社会のせいであって応募者のせいではないので、そこは差し引いて面接を行う必要があります。）
