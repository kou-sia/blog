...
**前置き**  
時間をかけて面接を受けていただいているので、できれば採用したいと思って面接をしています。  
応募者に本来の力を発揮してもらえるよう会話を誘導したりはします。  
この記事に登場する会話はサンプルです。  
...
面接官としておよそ一ヶ月数十回ほど、新卒中途問わずエンジニア/マネージャーの採用面接をおこないました。  
そこでわかった事を整理します。  
...
面接全体としてはチームメンバーとして一緒に働けるかどうかを見ます。  
...
「チームに居たら嬉しい方を採用することより『チームに居たら困る方を採用しない』こと」を重要視しています。  
そのため「凄くできる人を採用する」ということなどは特に考えていないです。  

以下の内容をどんどん掘り下げて聞いていきます。  
私の基準の場合はこれだけでほぼ全ての応募者の採用判断が可能です。  
カルチャーマッチなども重要ですが、以下を満たした場合のみ考慮します。
...
これらを理解している方は入社後に新しく使用するツールや技術なども問題なく習得できるだろうと判断しています。  

中途採用の場合は過去の仕事を聞くことが多いです。  
過去の仕事内容が技術的に深掘りしようが無い場合は[SystemDesign系面接](#systemdesign系面接)課題をで技術力を判断します。  
多重下請け構造でエンジニアをされている方の応募など、仕事内容が作業に終始しており応募者本人の能力の判断材料として全く当てにならない場合があります。  
しかしこれは日本社会のせいであって応募者のせいではないので、差し引いて判断して面接を行うようにしています。  
レジュメスクリーニングを突破しているので、過去の仕事内容は面接での判断には直接関係がないと考えています。  

## 応募者の振る舞いで気付いた、できれば避けてほしいこと 

面接をしている中での応募者の振る舞いで気づいたこと（そしてできれば避けて欲しいこと）を羅列していきます。  
※ 「採用基準に満たない方を採用しないこと」を重要視している都合上、ネガティブな話ばかりになりますがご容赦ください。  
