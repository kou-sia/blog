...
こういう質問の背景として入社された際には同じチームで働く可能性を想定しているからでもあります。そして、あくまでも面接官と応募者は対等な存在であり面接官に誤りがあればそれは指摘をして欲しいという意図もあります。  
...
具体的な進め方ですが、以下の内容をどんどん掘り下げていきます。  
これだけで応募者ほぼ全ての方の採用判断が可能です。  
...
(例えば多重下請け構造でエンジニアをされている方が応募されてくる場合などで、仕事内容が細分化された作業に終始しており説明を聞いても応募者本人の能力に対する判断材料として全く当てにならない場合が多々あります。しかしこれは日本社会のせいであって応募者のせいではないので、差し引いて判断して面接を行うようにしています。そもそもレジュメスクリーニングを突破しているということで、過去の仕事内容がどうなのかは面接での採用可否判断には直接関係がないと考えているためです。)  
