...
(というのもこれは日本特有なのかは分かりませんが、多重下請け構造の元でエンジニアをされている方が応募されてくる場合などで過去の成果が細分化された作業のみで、その応募者本人の能力などの判断材料として全く当てにならない場合が多々あります。しかし、これは日本社会のせいであって応募者のせいではないので、そこは差し引いて面接を行う必要があります。）
